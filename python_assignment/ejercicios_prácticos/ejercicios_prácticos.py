...
# Utilizando la siguiente lista y variable, determine si el valor de la variable coincide o o con un valor de la lista. *Sugerencia, si es necesario, utilice un bucle for in y el operador in.
